...
const FaqSection = () => {
  ...
  const faqs = [
    ...
    {
      id: 5,
      question: "What if something wrong with my order?",
      answer:
        "If you have any issues with your order, please contact our support team immediately. We'll do our best to resolve the issue and ensure you're satisfied with your meal.",
      icon: <FiHelpCircle className="text-xl" />,
    },

    {
      id: 6,
      question: "How does this help resturants?",
      answer:
        "We partner with restaurants to offer exclusive discounts and cashback rewards when you pay with $FORK tokens. This helps restaurants attract new customers and increase their sales.",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        {/* Fries - Right side */}
        <div
          className="absolute right-16 top-1/3 w-48 h-48 opacity-100"
          style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 top-24">
        ...
        {/* FAQ Cards */}
        <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto mb-20 md:mb-56">
          {/* Left Column - 6 cards */}
            ...
            {faqs.slice(0, 3).map((faq) => (
              ...
              >
                <div className="relative bg-white backdrop-blur-md rounded-2xl p-6 border border-white/20 hover:scale-105 transition-all duration-300 shadow-lg">
                  ...
                  >
                    <p className="text-[#111827] font-inter leading-relaxed">
                      {faq.answer}
                    </p>
                  </div>
                </div>
